...
type NodeInfo struct {
	...
	HttpHeaders         map[string]*StringList
...
type NameServerConfig struct {
	...
	// Add other fields if necessary from conf.NameServerConfig, or just Keep basic if unused by limiter
	// Limiter unlikely uses NameServerConfig. It's for NodeInfo.
}
